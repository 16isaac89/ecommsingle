<div id="sidebar" class="c-sidebar c-sidebar-fixed c-sidebar-lg-show">
    ...
    <ul class="c-sidebar-nav">
        ...
        @can('product_management_access')
            <li class="c-sidebar-nav-dropdown {{ request()->is("admin/product-categories*") ? "c-show" : "" }} {{ request()->is("admin/product-tags*") ? "c-show" : "" }} {{ request()->is("admin/products*") ? "c-show" : "" }} {{ request()->is("admin/product-variations*") ? "c-show" : "" }} {{ request()->is("admin/variations*") ? "c-show" : "" }} {{ request()->is("admin/subcategories*") ? "c-show" : "" }} {{ request()->is("admin/sub-sub-categories*") ? "c-show" : "" }}">
                <a class="c-sidebar-nav-dropdown-toggle" href="#">
                ...
                <ul class="c-sidebar-nav-dropdown-items">
                    ...
                    @can('subcategory_access')
                        <li class="c-sidebar-nav-item">
                            <a href="{{ route("admin.subcategories.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/subcategories") || request()->is("admin/subcategories/*") ? "c-active" : "" }}">
