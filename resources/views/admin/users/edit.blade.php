...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.users.update", [$user->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label class="required" for="photo">{{ trans('cruds.user.fields.profileimage') }}</label>
                <div class="needsclick dropzone {{ $errors->has('profileimage') ? 'is-invalid' : '' }}" id="photo-dropzone">
                </div>
