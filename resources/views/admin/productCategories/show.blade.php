...
<div class="card">
    ...
    <ul class="nav nav-tabs" role="tablist" id="relationship-tabs">
        <li class="nav-item">
            <a class="nav-link" href="#product_category_subcategories" role="tab" data-toggle="tab">
    ...
    <div class="tab-content">
        <div class="tab-pane" role="tabpanel" id="product_category_subcategories">
            @includeIf('admin.productCategories.relationships.productCategorySubcategories', ['subcategories' => $productCategory->productCategorySubcategories])
        </div>
